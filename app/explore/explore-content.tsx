...
import { VerifiedTrustBadge } from "@/components/verified-badge"
...
export function ExploreContent() {
  ...
  const getFiltersFromURL = useCallback((): Partial<SpecialistFilters> => {
    return {
      ...
      consultationType: (searchParams.get("modality") as "all" | "online" | "in_person") || "all",
      ...
      sortBy: (searchParams.get("sort") as "rating" | "price_asc" | "price_desc" | "availability") || "rating",
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-6">
              ...
              <div className="flex justify-center">
                <VerifiedTrustBadge isSpanish={lang === "es"} className="max-w-xl" />
              </div>
            </div>
