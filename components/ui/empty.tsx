...
function Empty({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="empty"
      className={cn(
        "flex min-w-0 flex-1 flex-col items-center justify-center gap-6 rounded-xl border-dashed border-teal-200/20 dark:border-teal-800/30 p-6 text-center text-balance md:p-12",
        className
      )}
      {...props}
    />
