...
export function VerificationLinkEmail({
  ...
  return (
    <Html lang="es">
      <Head />
      <Preview>Verifica tu cuenta NUREA — haz clic en el enlace</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={card}>
            <Section style={header}>
              <Heading style={headerTitle}>NUREA</Heading>
              <Text style={headerSubtitle}>Verificación de email</Text>
            </Section>
            <Section style={content}>
              ...
              <Text style={paragraph}>
                Te hemos enviado este enlace para verificar tu correo y activar tu cuenta.
              </Text>
              <Text style={paragraph}>
                Haz clic en el botón de abajo. El enlace es de un solo uso y caduca en poco tiempo.
              </Text>
              ...
              <Link href={verificationLink} style={fallbackLink}>
                {verificationLink}
              </Link>
            </Section>
            <Hr style={hr} />
